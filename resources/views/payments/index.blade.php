                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($senderT as $trans)
                                                    <tr>
                                                        <td><img src="{{ asset($trans['img']) }}" class=" rounded-circle mr-3" alt="">{{ $trans['name'] }}</td>
                                                        <td>{{$trans['jobID']}}</td>
                                                        <td>Milestone {{$trans['mID']}}</td>
                                                        <td>
                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($receiverT as $trans)
                                                    <tr>
                                                        <td><img src="{{ asset($trans['img']) }}" class=" rounded-circle mr-3" alt="">{{$trans['name']}}</td>
                                                        <td>Project {{$trans['jobID']}}</td>
                                                        <td>Milestone {{$trans['mID']}}</td>
                                                        <td>
